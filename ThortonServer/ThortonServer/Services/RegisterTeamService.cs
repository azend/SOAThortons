...
{
    class RegisterTeamService : AbstractService
    {
        public RegisterTeamService()
        {
            //searchRegex = new Regex("[" + HL7SpecialChars.BOM + "]DRC[|]REG-TEAM[|][|][|][" + HL7SpecialChars.EOS + "]INF[|](.*)[|][" + HL7SpecialChars.EOS + "][" + HL7SpecialChars.EOM + "][" + HL7SpecialChars.EOS + "]");
            searchRegex = new Regex("DRC[|]REG-TEAM[|][|][|][" + HL7SpecialChars.EOS + "]INF[|](.*)[|][" + HL7SpecialChars.EOS + "][" + HL7SpecialChars.EOM + "][" + HL7SpecialChars.EOS + "]");
